...
/**
 * Transforms a So1Record data object to mainframe data.
 * <p/>
 * This is a typical use of this class:
 * <pre>
 *  So1RecordJavaToHostTransformer transformer = new So1RecordJavaToHostTransformer();
 *  byte[] hostByteArray = transformer.transform(javaValue);
 * </pre>
 *
 */
public class So1RecordJavaToHostTransformer extends AbstractJavaToHostTransformer {

    
    /**
     * Create a Java to Host transformer using default COBOL parameters.
     */
    public So1RecordJavaToHostTransformer() {
        super();
    }
     ...
     */
    public So1RecordJavaToHostTransformer(final CobolContext cobolContext) {
        super(cobolContext);
    }
     ...
     */
    public So1RecordJavaToHostTransformer(final String hostCharset) {
        super(hostCharset);
    }
